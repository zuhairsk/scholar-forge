        ...
        <AnimatePresence mode="wait">
          ...
          {step === 3 && role === 'author' && (
            <motion.div key="s3a" initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -40 }} className="space-y-6 text-center">
              ...
              <GoldButton className="w-full h-12" onClick={() => router.push('/dashboard/author')}>Enter Dashboard →</GoldButton>
            </motion.div>
          )}
          ...
          {step === 4 && role === 'reviewer' && (
            <motion.div key="s4" initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -40 }} className="text-center space-y-6">
              ...
              <GoldButton className="w-full h-12" onClick={() => router.push('/dashboard/reviewer')}>I've verified my email →</GoldButton>
            </motion.div>
          )}
        </AnimatePresence>
